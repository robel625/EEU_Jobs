...
function SideNavbar() {
  ...
  return (
    <div className='mt-14 bg-slate-200 '>
        <div className={` ${open ? "w-52" : "w-20"} text-black py-6 px-3  bg-white  top-6 z-20  left-0 
          peer-focus:left-0 peer:transition ease-out delay-150 duration-300 relative`}>
            ...
            <div className="flex flex-col justify-start item-center">
                ...
                <div className=" my-4 border-b border-gray-100 pb-4">
                    ...
                    <Link href="/admin/" passHref><SideNavbarbtn Icon={HomeRoundedIcon} text="Home" open={open} active/></Link>
